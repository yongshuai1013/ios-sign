...
export type AppPage = 'login' | 'sign' | 'pairing' | 'direct-install' | 'refresh' | 'moto-unlock';
...
const KNOWN_HASHES = new Set([LOGIN_PAGE_HASH, SIGN_PAGE_HASH, PAIRING_PAGE_HASH, DIRECT_INSTALL_PAGE_HASH, REFRESH_PAGE_HASH, MOTO_UNLOCK_PAGE_HASH]);
